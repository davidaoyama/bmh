      ...
      <main className="min-h-screen">
        ...
        <section id="projects" className="px-6 sm:px-10 md:px-20 pb-20">
          ...
          >
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 text-base sm:text-lg font-medium text-black hover:text-gray transition-colors duration-200"
            >
              See all of my works
              <ArrowRight size={18} />
            </Link>
        ...
        <section className="px-6 sm:px-10 md:px-20 py-24">
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-20">
            ...
            >
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 mt-8 text-base sm:text-lg font-medium text-black hover:text-gray transition-colors duration-200"
              >
                Learn more about me
                <ArrowRight size={18} />
              </Link>
